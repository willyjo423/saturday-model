...
from cfb import config, daily, schema  # noqa: E402
from cfb.dataset import clean_games  # noqa: E402
from cfb.features import build_features, training_matrix  # noqa: E402
from cfb.model import CFBModel  # noqa: E402
...
from cfb.api import CFBDError as _Unavailable  # noqa: E402
...
def train_stub_model(world) -> None:
    ...
    from cfb.dataset import add_rest_and_travel
...
def main() -> int:
    ...
    from cfb.dashboard import render
    html = render(payload)
